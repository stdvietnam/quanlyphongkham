Public Class XtraReport_5
    ...
    Public Property ImgSource6() As String
        Get
            Return m_ImgSource6
        End Get
        Set(ByVal value As String)
        ...
        End Set
    End Property
    Private m_ImgSource6 As String
    ...
    Protected Overrides Sub BeforeReportPrint()
        ...
        XrPictureBox3.ImageUrl = ImgSource3
        XrPictureBox4.ImageUrl = ImgSource4
        XrPictureBox5.ImageUrl = ImgSource6
