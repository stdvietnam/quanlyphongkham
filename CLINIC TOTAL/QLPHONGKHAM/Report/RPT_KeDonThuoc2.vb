...
Public Class RPT_KeDonThuoc2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MEDICAL.RPT_KeDonThuoc2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_KeDonThuoc2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_KeDonThuoc2 = New RPT_KeDonThuoc2()
        rpt.Site = Me.Site
        Return rpt
    End Function
