...
Public Class rpt_soxetnghiem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MEDICAL.rpt_soxetnghiem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_soxetnghiem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_soxetnghiem = New rpt_soxetnghiem()
        rpt.Site = Me.Site
        Return rpt
    End Function
