...
Public Class RPT_THONGKE_SIEUAM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MEDICAL.RPT_THONGKE_SIEUAM.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Tongtien() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_THONGKE_SIEUAM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_THONGKE_SIEUAM = New RPT_THONGKE_SIEUAM()
        rpt.Site = Me.Site
        Return rpt
    End Function
