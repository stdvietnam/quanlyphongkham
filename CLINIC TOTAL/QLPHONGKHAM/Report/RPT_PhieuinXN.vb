...
Public Class RPT_PhieuinXN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MEDICAL.RPT_PhieuinXN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_PhieuinXN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_PhieuinXN = New RPT_PhieuinXN()
        rpt.Site = Me.Site
        Return rpt
    End Function
