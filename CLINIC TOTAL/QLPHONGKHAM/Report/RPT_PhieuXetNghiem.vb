...
Public Class RPT_PhieuXetNghiem
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MEDICAL.RPT_PhieuXetNghiem.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_PhieuXetNghiem
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_PhieuXetNghiem = New RPT_PhieuXetNghiem()
        rpt.Site = Me.Site
        Return rpt
    End Function
