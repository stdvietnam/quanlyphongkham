...
Public Class rptPhieuXN_xuatHC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MEDICAL.rptPhieuXN_xuatHC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPhieuXN_xuatHC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPhieuXN_xuatHC = New rptPhieuXN_xuatHC()
        rpt.Site = Me.Site
        Return rpt
    End Function
