...
Public Class RPT_phieuhenkham
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MEDICAL.RPT_phieuhenkham.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_phieuhenkham
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_phieuhenkham = New RPT_phieuhenkham()
        rpt.Site = Me.Site
        Return rpt
    End Function
