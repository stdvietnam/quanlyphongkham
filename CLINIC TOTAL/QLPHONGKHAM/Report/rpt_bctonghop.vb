...
Public Class rpt_bctonghop
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MEDICAL.rpt_bctonghop.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Ngaythang() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrpt_bctonghop
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_bctonghop = New rpt_bctonghop()
        rpt.Site = Me.Site
        Return rpt
    End Function
