...
Public Class rptPhieunhapthuoc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MEDICAL.rptPhieunhapthuoc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPhieunhapthuoc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPhieunhapthuoc = New rptPhieunhapthuoc()
        rpt.Site = Me.Site
        Return rpt
    End Function
