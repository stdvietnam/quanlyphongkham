...
Public Class rpt_sokhambenh
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MEDICAL.rpt_sokhambenh.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_sokhambenh
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_sokhambenh = New rpt_sokhambenh()
        rpt.Site = Me.Site
        Return rpt
    End Function
