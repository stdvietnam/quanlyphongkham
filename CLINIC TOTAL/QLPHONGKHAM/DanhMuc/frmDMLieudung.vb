        ...
        If txtTen.Text.Trim.Length > 0 Then
            Try
                If txtID.Text <> "0" Then
                    Command_Exc("Update DM_LIEUDUNG Set Lieudung=N'" & txtTen.Text & "' Where ID=" & Integer.Parse("0" + txtID.Text), CNNQLPHONGKHAM)
                Else
                    Command_Exc("Insert Into DM_LIEUDUNG(Lieudung) Values(N'" & txtTen.Text & "')", CNNQLPHONGKHAM)
                End If
            ...
            End Try
        Else
            MessageBox.Show("Tên liều dùng không được để trống...!")
            txtTen.Focus()
            Exit Sub
        End If
